export default function ServicesFooterCTA() {
  return (
    <section className="bg-ink text-cream py-20 px-6 text-center">
      <h3 className="font-cormorant text-[36px] md:text-[44px] font-light text-cream leading-tight mb-4" data-reveal>
        Ready to elevate your brand?
      </h3>
      <p
        className="font-jost font-light text-[14px] text-[rgba(250,249,247,0.45)] mb-10 max-w-md mx-auto leading-relaxed"
        data-reveal
